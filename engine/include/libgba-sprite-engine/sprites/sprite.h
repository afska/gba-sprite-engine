...
public:
    ...
    inline void makeAnimated(int beginFrame, int numberOfFrames, int animationDelay);
...
inline void Sprite::makeAnimated(int beginFrame, int numberOfFrames, int animationDelay) {
    previousFrame = -1;
